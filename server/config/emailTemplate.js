...
console.log(userAbstract,finalPaperStatus,paymentStatus,otp);
    ...
    if (userAbstract.toLowerCase() === "rejected") {
      ...
      dynamicContentHtml = `
        <p style="margin-top:20px;color:#ff0000;">
          ...
          <b>Reason:</b> ${rejectedReason || "Not specified by admin"}
        </p>
      `;
    } else {
  ...
  // --------------------------
    ...
    if (finalPaperStatus.toLowerCase() === "rejected") {
      ...
      `;
    } else if(finalPaperStatus.toLowerCase()== "rejected") {
  ...
  // --------------------------
    ...
    if (paymentStatus.toLowerCase() === "unpaid") {
      bannerHtml = `<img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" alt="Payment Rejected Banner" style="width:100%; max-width:600px; border-radius:8px 8px 0 0;" />`;
      dynamicContentHtml = `
        <p style="margin-top:20px;color:#ff0000;">  
          <b>User Name:</b> ${userName}<br/>
